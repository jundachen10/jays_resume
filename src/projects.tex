...
\resumeItemListStart
\resumeItem{This resume is written in LaTeX code}
\resumeItem{Built a custom Github action that auto builds a pdf file on commits(click the link above to see it in action)}
\resumeItemListEnd
\resumeProjectHeading
